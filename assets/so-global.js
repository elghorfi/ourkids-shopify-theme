  ...
  getEngravingVariant() {
    ...
    for (var i = 0; i < variants.length; i++) {
      var variant = variants[i],
          currentPopupImage = document.querySelector('.featured-image img'),
          currentPopupImageSrc = currentPopupImage.src.split(),
      ...
      {
        currentPopupImage.src = variant.featured_image.src;
...
class SoVariantRestoreDefault extends SoVariantSelects {
  constructor() {
    super();
...
customElements.define('so-submit-default-form', SoVariantRestoreDefault);
...
class EngravingInput extends SoVariantSelects {
  constructor() {
    ...
    this.engravingInput = this.querySelectorAll('.so-engraving-input');
